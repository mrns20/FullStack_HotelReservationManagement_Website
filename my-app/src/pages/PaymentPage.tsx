...
const PaymentPage: React.FC = () => {
  const [paymentType, setPaymentType] = useState<"credit" | "cash" | null>(
    null
  );
  ...
  return (
    <div className="container">
      ...
      <form
        onSubmit={
          paymentType === "credit" ? handleSubmitCreditCard : handleSubmitCash
        }
        autoComplete="on"
      >
        ...
        {paymentType === "cash" && (
          <div className="form-container" id="cashForm">
            ...
            <input
              ...
              id="depo"
              name="depo"
              value="Advance deposit (50€) to the following bank account:"
              required
              disabled
            />
            <input
              ...
              id="depo2"
              name="depo2"
              value="E123 WERT OKOK 1313 4589 100P"
              required
              disabled
            />
            <p>
              *In case of non-payment of the advance payment within 5 working
              days, the reservation is cancelled.
            </p>
            <p>**Sending proof of advance payment by email.</p>
            <input
              type="submit"
              className="submit"
              value="Pay in cash at check-in time"
            />
          </div>
        )}
