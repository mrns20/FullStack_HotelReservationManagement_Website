...
import axiosInstance from "../axiosConfig"; // Import axiosInstance for Axios requests
...
const NeedHelp: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Make a POST request to send the message data
      const response = await axiosInstance.post("/messages/", formData); // Use the endpoint from your backend
